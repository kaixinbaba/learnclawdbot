...
Connect your AI assistant to WhatsApp and chat with it just like a friend. OpenClaw uses WhatsApp Web (via Baileys) to provide a seamless messaging experience — no business API needed, no 24-hour reply windows, just pure personal assistant magic.
...
- Node.js runtime (**not Bun** — Baileys is unreliable on Bun)
...
- **Avoid:** Google Voice, TextNow, "free SMS" services — WhatsApp blocks these
...
- **Don't share:** Never share your `creds.json` — it provides full access to your WhatsApp account.
...
- ✅ **Group chat support** with mention activation
- ✅ **Media handling** for images, videos, and voice notes
- ✅ **Auto-reactions** for instant feedback
- ✅ **Multi-account** support

Your AI assistant is now available on WhatsApp! 💬
