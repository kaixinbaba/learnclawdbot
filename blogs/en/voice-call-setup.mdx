...
3. Try the fallback chain: Deepgram → OpenAI → Groq → Local Whisper
...
- ✅ **STT** via Deepgram, OpenAI Whisper, or Groq
- ✅ **TTS** via OpenAI or ElevenLabs
- ✅ **Webhooks** for real-time call handling
- ✅ **Inbound policies** for receiving calls

Your AI assistant can now talk on the phone! 🎉
