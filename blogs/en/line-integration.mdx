...
✅ Send rich interactive content with Flex Messages  
✅ Share media, locations, and quick replies  
✅ Control access with pairing, allowlist, or open policies  
✅ Manage multiple LINE accounts from one gateway  
