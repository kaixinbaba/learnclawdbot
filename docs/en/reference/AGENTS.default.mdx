...
summary: "Default AGENTS.md template for OpenClaw personal assistant setup"
---
...
- Direct chats collapse into the agent's main session by default; groups stay isolated as `agent:::group:<id>`; rooms/channels: `agent:::channel:<id>`; heartbeats keep background tasks alive.
