---
title: "BOOTSTRAP"
summary: "First-run template for new agent workspace initialization"
---
...
- Run the recommended host healthcheck using the healthcheck skill
- Skip for now (run later by saying "run healthcheck")
