---
summary: "链接到所有 OpenClaw 文档的中心"
read_when:
  - 你想要一个完整的文档地图
---
# 文档中心

使用这些中心来发现每一个页面，包括左侧导航中未出现的深入研究和参考文档。
...
- [向导](/start/wizard)
- [设置](/start/setup)
- [仪表板（Dashboard）（本地网关）](http://127.0.0.1:18789/)
- [帮助](/help)
...
- [健康检查](/gateway/health)
- [心跳（Heartbeat）](/gateway/heartbeat)
- [Doctor](/gateway/doctor)
- [日志](/gateway/logging)
- [沙箱](/gateway/sandboxing)
- [仪表板（Dashboard）](/web/dashboard)
- [控制界面](/web/control-ui)
- [远程访问](/gateway/remote)
...
- [macOS 语音叠加层](/platforms/mac/voice-overlay)
