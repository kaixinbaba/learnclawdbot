...
OpenAI는 GPT 모델을 위한 개발자 API를 제공합니다. Codex는 구독 접근을 위한 **ChatGPT 로그인** 또는 사용량 기반 접근을 위한 **API 키** 로그인을 지원합니다. Codex cloud는 ChatGPT 로그인이 필요합니다.

## 옵션 A: OpenAI API 키 (OpenAI Platform)

**최적:** 직접 API 접근 및 사용량 기반 청구.
...
**최적:** API 키 대신 ChatGPT/Codex 구독 접근 사용.
Codex cloud는 ChatGPT 로그인이 필요하며, Codex CLI는 ChatGPT 또는 API 키 로그인을 지원합니다.
